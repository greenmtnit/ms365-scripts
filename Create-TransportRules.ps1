...
$HTMLDisclaimerSuspiciousExternalEmail = '<table border=0 cellspacing=0 cellpadding=0 align="left" width="100%">
  <tr>
   ...
   <div style="color:#222222;">
        ...
        This is an external email and has a suspicious subject or content, such as a message asking for a payment or password. This may be legitimate, but please take care when clicking links or opening attachments. When in doubt, contact your IT provider.
      </div>
    </td>
  </tr>
</table>
